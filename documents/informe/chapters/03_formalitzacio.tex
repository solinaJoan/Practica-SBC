...
\subsection{Procés de Construcció de l'Ontologia}
...
\subsection{Descripció de l'Ontologia}

\subsubsection{Visió General}
...
\textbf{Jerarquia de Solicitants}
...
\fbox{\includegraphics[width=0.9\textwidth]{ServeiComercial.png}}
...
\fbox{\includegraphics[width=16cm]{ServeiEducatiu.png}}
...
\fbox{\includegraphics[width=16cm]{ServeiOci.png}}
...
\fbox{\includegraphics[width=16cm]{Serveisalut.png}}
...
\fbox{\includegraphics[width=16cm]{ServeiTransport.png}}
...
\fbox{\includegraphics[width=16cm]{ZonaVerda.png}}

\end{itemize}

\textbf{Jerarquia de Localització}

La classe \texttt{Localitzacio} modela la informació geogràfica i administrativa de les ubicacions.

\textbf{Jerarquia d'Ofertes}
...
\subsection{Descripció dels atributs}

\subsubsection{Atributs de Solicitant}
...
\subsubsection{Atributs d'Habitatge}
...
\subsubsection{Atributs de Servei}
...
\subsubsection{Atributs de Localització}
...
\subsubsection{Atributs d'Oferta}
