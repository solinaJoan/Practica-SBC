...
\textbf{Models de llenguatge.} Tal com s'indica a l'enunciat, podíem utilitzar models de llenguatge com a ``experts'' per fer elicitació de coneixement sobre criteris de decisió en la recomanació d'habitatges. Tot i que no ho hem documentat extensament en aquest apartat, és una via legítima per obtenir coneixement estructurat sobre el domini.
